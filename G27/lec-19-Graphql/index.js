...
const resolvers ={
    Query:{
        ...
        getUser:(_,args)=>{
            ...
            return user; //{id:"1",name:"Nitesh",phone}
            // return users[0];
        },
            getAllPosts:()=>{
            return posts; 
    ...
    Mutation:{
        login:(parent,args)=>{
            ...
            if(!user) return {message:"Email doesnot exist",token:null};
            if(user.password!=password) return {message:"password incorrect",token:null};
